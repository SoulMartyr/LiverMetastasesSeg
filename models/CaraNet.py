...
class caranet(nn.Module):
    ...
    def forward(self, x):
        ...
        # ------------------- atten-one -----------------------
        decoder_2 = F.interpolate(decoder_1, scale_factor=0.25, mode='bilinear', align_corners=True, recompute_scale_factor=True)
        ...
        x_1 = ra_1 + decoder_4
        lateral_map_5 = F.interpolate(x_1,scale_factor=8,mode='bilinear', align_corners=True) 
