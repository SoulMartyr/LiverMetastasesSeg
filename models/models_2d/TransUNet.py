...
from .base_models.ResNetV2 import ResNetV2
...
class TransUNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=3, vit_name='R50-ViT-B_16', img_size=224, zero_head=False, vis=False):
        ...
        self.classifier = config_vit.classifier
        self.transformer = Transformer(config_vit, img_size, vis)
        ...
        if exists(config_vit.pretrained_path):
            self.load_from(weights=np.load(config_vit.pretrained_path))
...
class Configs:
    ...
    def get_b16_config():
        ...
        config.pretrained_path = './checkpoints/vit_checkpoint/imagenet21k/ViT-B_16.npz'
    ...
    def get_r50_b16_config():
        ...
        config.classifier = 'seg'
        config.pretrained_path = './checkpoints/vit_checkpoint/imagenet21k/R50+ViT-B_16.npz'
        config.decoder_channels = (256, 128, 64, 16)
    ...
    def get_b32_config():
        ...
        config.pretrained_path = './checkpoints/vit_checkpoint/imagenet21k/ViT-B_32.npz'
        return config
    ...
    def get_l16_config():
        ...
        config.classifier = 'seg'
        config.resnet_pretrained_path = None
        config.pretrained_path = './checkpoints/vit_checkpoint/imagenet21k/ViT-L_16.npz'
        config.decoder_channels = (256, 128, 64, 16)
        config.n_classes = 2
        config.activation = 'softmax'
        return config
    ...
    def get_r50_l16_config():
        ...
        config.classifier = 'seg'
        config.resnet_pretrained_path = './checkpoints/vit_checkpoint/imagenet21k/R50+ViT-B_16.npz'
        config.decoder_channels = (256, 128, 64, 16)
        config.skip_channels = [512, 256, 64, 16]
        config.n_classes = 2
        config.activation = 'softmax'
