...
class CE_Net_(nn.Module):
    ...
    def forward(self, x):
        ...
        out = F.interpolate(self.finaldeconv1(d1), size=size, mode="bilinear", align_corners=True)
